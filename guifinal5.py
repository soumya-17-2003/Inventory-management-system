...
Label(root, text="User ID:", font=("Helvetica", 12), bg="white", fg="black").pack(pady=5)
entry_id = Entry(root, font=("Helvetica", 12), fg="black", bg="white")
entry_id.pack(pady=5)

# Password Label and Entry
Label(root, text="Password:", font=("Helvetica", 12), bg="white", fg="black").pack(pady=5)
entry_password = Entry(root, show='*', font=("Helvetica", 12), fg="black", bg="white")
entry_password.pack(pady=5)

# Login Button
Button(root, text="Login", command=verify_login, font=("Helvetica", 12), bg="#28A745", fg="black").pack(pady=20)
